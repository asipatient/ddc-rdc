...
export const flagshipPrograms: Program[] = [
  {
    slug: "ecole-citoyenne",
    title: "L'École Citoyenne",
    shortTitle: "École Citoyenne",
    icon: "book",
  ...
  {
    slug: "think-tank-ddc",
    title: "Think Tank DDC - Laboratoire d'idées",
    shortTitle: "Think Tank DDC",
    icon: "search",
    axisSlug: "gouvernance-citoyennete-transformation-sociale",
    description:
  ...
  },
  {
    ...
    title: "Programme d'Alerte Communautaire",
    shortTitle: "Alerte Communautaire",
    icon: "radar",
    axisSlug: "gouvernance-citoyennete-transformation-sociale",
    description:
  ...
  {
    slug: "projec",
    title: "Programme Jeunes pour l'Éveil Économique - PROJEC",
    shortTitle: "PROJEC",
    icon: "briefcase",
  ...
  },
  {
    ...
    title: "Programme Vert et Climat",
    shortTitle: "Vert et Climat",
    icon: "leaf",
    axisSlug: "autonomisation-economique-resilience",
    description:
  ...
  },
  {
    ...
    title: "Programme JASIRI - Leadership Féminin",
    shortTitle: "JASIRI",
    icon: "shield",
  ...
  {
    slug: "kongo-culture",
    title: "Programme Kongo Culture",
    shortTitle: "Kongo Culture",
    icon: "palette",
    axisSlug: "identite-inclusion-capital-humain",
    description:
  ...
  {
    slug: "creative-child",
    title: "Programme Creative Child",
    shortTitle: "Creative Child",
    icon: "sparkles",
    axisSlug: "identite-inclusion-capital-humain",
    description:
...
export const programs = flagshipPrograms;
