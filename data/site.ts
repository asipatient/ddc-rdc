...
export const site = {
  ...
  shortName: "DDC RDC",
  legalName: "DDC RDC ASBL",
  locale: "fr",
  futureLocales: ["en"],
  slogan: "Jeunesse, femmes et communautés debout pour un Congo juste, inclusif et durable.",
  description:
    "La DDC RDC ASBL mobilise la jeunesse et les femmes congolaises pour construire des communautés responsables, résilientes, créatives, inclusives et engagées dans la transformation démocratique, sociale, économique, culturelle et environnementale de la République Démocratique du Congo.",
...
export const home = {
  ...
  heroSubtitle:
    "La DDC RDC ASBL mobilise la jeunesse et les femmes congolaises pour construire des communautés responsables, résilientes, créatives, inclusives et engagées dans la transformation démocratique, sociale, économique, culturelle et environnementale de la République Démocratique du Congo.",
  reason:
    "La Dynamique Debout Congolais, DDC RDC ASBL, est une plateforme institutionnelle congolaise d'éveil citoyen, de leadership, d'autonomisation économique, de recherche, de culture, d'environnement, de paix et de développement communautaire.",
  reasonFollowUp:
