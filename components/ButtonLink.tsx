...
const variants = {
 primary:"bg-brand-gold text-brand-blue hover:bg-surface-elevated dark:text-brand-blue",
 secondary:"bg-brand-blue text-white hover:bg-brand-green dark:bg-brand-blue dark:text-white dark:hover:bg-brand-green",
 outline:"border border-white/70 text-white hover:bg-surface-elevated hover:text-brand-blue",
